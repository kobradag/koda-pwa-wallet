...
class KobraPWA extends EventEmitter {
	constructor(appFolder){
		...
		console.log('');
		console.log('_  _ ____ ___  ____  ____    _ _ _ ____ _    _    ____ ___    ____ ____ ____ _  _ ____ ____ ');
		console.log('|_/  |  | [__| |__]  |__|    | | | |__| |    |    |___  |     [__  |___ |__/ |  | |___ |__/ ');
		console.log('|  \\ |__| |__] | \\   |  |    |_|_| |  | |___ |___ |___  |     ___] |___ |  \\  \\/  |___ |  \\ ');
		console.log('');
